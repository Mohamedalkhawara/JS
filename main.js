0// 1-  Declare a variable called "name" and assign it the value "John". 
/******* Start Your Code *********/
...
let info = "my name is ${name} and I am ${age}";
...
let messageLenghth = message.Lenghth;
...
let messageSlice = message.slice(0, 4);
